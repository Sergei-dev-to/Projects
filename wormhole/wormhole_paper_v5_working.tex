...
\begin{abstract}
Can motion near one mouth of a traversable wormhole create a new long-range
$1/r$ Coulomb or Newtonian field at the other mouth?  The Dai--Stojkovic search
proposal assumes such cross-throat monopole induction.  We show that this
effect is absent in the settings analyzed here.

In Maxwell theory, spacetime Stokes applied to a worldtube around a mouth fixes
that mouth's flux, so the opposite-side $1/r$ coefficient cannot change unless
charge crosses the corresponding worldtube.  In gravity, the two-ended case
follows from separate conservation of the ADM masses at distinct
asymptotically flat ends.

The single-ended gravitational case requires more care, because
there is no separate ADM mass for each mouth.  For a timelike worldtube
enclosing the throat, we derive a Brown--York balance law: the Brown--York
throat energy is fixed when no stress-energy crosses the worldtube and no
Brown--York boundary work is done.  With a stationary vacuum exterior, or at
first order in perturbation theory, this throat statement also fixes the
exterior mouth $1/r$ coefficient under stated additional assumptions.

We therefore exclude Dai--Stojkovic cross-throat monopole induction in the
regimes treated here.  Other wormhole signatures remain: pre-existing mouth
charges or masses, higher multipoles, waves, and transit or backreaction
through the throat.  Flux-driven backreaction is the channel described by
Frolov--Novikov and by Cramer et al.
\end{abstract}
...
$1/r$ coefficient at the other mouth.  We call this cross-throat monopole
induction.

Figure~\ref{fig:thin-shell-zero-flux} illustrates the meaning of a fixed flux
sector in Maxwell theory.  It shows a point charge near a flat spherical
thin-shell wormhole, obtained by gluing two Euclidean exteriors at a sphere
\cite{Visser1995LorentzianWormholes}, in the fixed $Q_{\rm wh}=0$ sector.
The oriented integral of the normal electric field over the throat
vanishes, but the normal field itself need not vanish pointwise.  Individual
flux tubes can pass through the throat and return through another angular band,
while the complete tubes sourced by the charge still run from the charge to the
source-side asymptotic infinity.
...
appearance of a net monopole.  For the wormhole, the corresponding statement
is the fixed-flux conservation law derived in Sec.~\ref{sec:maxwell}.
...
The effect proposed by Dai and Stojkovic would require the observed $1/r$
coefficient at one mouth to vary in response to source motion on the other
side.  We show that this cross-throat monopole channel is absent in the
regimes treated here.  In Maxwell theory, the spacetime Stokes argument fixes
the relevant flux at each mouth.  When a wormhole connects two asymptotically
flat ends, the gravitational analogue is separate conservation of the ADM
charges at those ends.  In the single-ended gravitational case, the exact
nonlinear result is quasi-local:
the Brown--York throat energy of a worldtube enclosing the throat can change only if
stress-energy crosses the worldtube or Brown--York boundary work is done by
changing the worldtube geometry.

Source motion confined to one side cannot produce that signal unless current
or stress-energy crosses the relevant worldtube, or Brown--York boundary work
...
shows the corresponding Maxwell field-line response at fixed throat flux.}
\end{figure}

We assume that traversable wormholes are admissible geometries.  Such spacetimes lie
outside the hypotheses of standard topological censorship; in asymptotically
flat general relativity they require violations of the averaged null energy
condition or modified dynamics
...
Relative to prior work, the Maxwell result of Sec.~\ref{sec:maxwell} is the
local worldtube form of Frolov and Novikov's electromagnetic flux conservation
\cite{FrolovNovikov1990PhysicalEffects}, restated here in spacetime-Stokes
form for a surface around a chosen mouth; the homological framing in
...
The present paper treats the Maxwell and gravitational cases side by side:
per-end ADM rigidity in the two-ended case, a Brown--York worldtube balance
law with an explicit boundary-work term in the single-ended case, and a
conditional bridge from the throat balance to the observable mouth $1/r$
coefficient under stationary-vacuum or linearized assumptions.  The resulting
fixed-sector obstruction applies to the Dai--Stojkovic detection channel
without relying on spherical symmetry or Birkhoff's theorem.

Section~\ref{sec:quantities} defines the charges, field sectors, and response
channels used in the rest of the paper.  Sections~\ref{sec:maxwell}--\ref{sec:mouth-bridge}
state the Maxwell, ADM, Brown--York, and conditional mouth-response results.
Sections~\ref{sec:ds}--\ref{sec:consequences} apply them to the
Dai--Stojkovic channel, transit/backreaction, and observational scalings.
...
We use ``mass of a wormhole mouth'' for three different quantities.  The
...
We use ``sector'' for a class of field data with the same conservation or
propagation behavior, and ``channel'' for a physical mechanism that can produce
a response.
...
sources are enclosed.  This is the Dai--Stojkovic observable.  A local mouth
coefficient is well defined in Maxwell theory, in stationary vacuum
gravity where Komar integrals are available, and in linearized gravity where
the nonradiative $\ell=0$ sector is a constraint charge.

\subsection{Throat energy}

For fully nonlinear single-ended gravity, the finite-region quantity used in
the rest of the paper is the quasi-local energy on a timelike worldtube
enclosing the throat.  We use the Brown--York boundary stress tensor
...
time flow $\xi^a$, $S_t$ is the corresponding two-dimensional spatial
...
cannot change this sector without the corresponding flux or boundary work.
...
stress-energy crossing the relevant worldtube, or Brown--York boundary work on
...
%% ============================================================
\section{Maxwell Theory: Flux Charges Are Rigid}
\label{sec:maxwell}
%% ============================================================

We first treat Maxwell theory on a fixed wormhole background.  The Maxwell
conservation law used here has direct precedents: Frolov and Novikov derived the
corresponding integral laws for electromagnetic fluxes in multiply connected
wormhole spacetimes, including the statement that motion of exterior charges
does not change the flux through the wormhole unless charged particles pass
through the handle~\cite{FrolovNovikov1990PhysicalEffects}.  Krasnikov later
used the same fixed-sector idea in the electrostatic point-charge problem
\cite{Krasnikov2008ElectrostaticInteraction}.  We use the local worldtube form
because it is the form needed for cross-throat monopole induction and for the
gravitational comparison below.
...
This is a statement about the spacetime history of the measuring surface, not
about a spatial volume bounded by $S_t$.  Thus the surfaces $S_t$ need not be
...
without current flux through its own swept worldtube.  Conservation therefore
applies to each chosen flux sector, not only to a sum over all mouths or ends.
...
The local form is the following.
...
This is the local worldtube form of Frolov--Novikov's homological flux law for
closed two-surfaces in a multiply connected spacetime
\cite{FrolovNovikov1990PhysicalEffects}, written for the surface surrounding a
chosen mouth.
...
Maxwell theory already illustrates the main principle.  A wormhole may carry a
nonzero Coulomb field without a localized charge, but that field is a sector
label.  Moving a charge near the other mouth does not change that sector label.
Appendix~\ref{app:cohomology} gives the homological form of this statement.
...
Gravity is less local than Maxwell theory in this respect: there is no
gauge-invariant gravitational flux through an arbitrary closed two-surface
whose value is a conserved monopole charge.  At an asymptotically flat end,
the Hamiltonian charge associated with an asymptotic time translation is the
ADM mass, so a two-ended spacetime has separate ADM Hamiltonians for the two
ends.  A finite surface around a mouth in a single-ended wormhole is different,
because it is not an ADM boundary.  The finite-boundary quantity in this paper
is instead the Brown--York throat energy $E_{\mathcal W}$ on a timelike
worldtube enclosing the throat.
Its balance law contains both stress-energy flux and boundary work.  Only in
stationary or linearized regimes can this throat statement be related to the
local mouth $1/r$ coefficient used in the Dai--Stojkovic observable.

The section therefore separates two cases.  In a two-ended spacetime, the
relevant exact monopole charges are the ADM charges at the two asymptotic
ends, and these charges are conserved end by end.  In a single-ended wormhole,
there is no per-mouth ADM charge, so the exact statement has to be made on a
finite worldtube around the throat.  The connection to a local mouth coefficient
is then an additional stationary or perturbative bridge, not an ADM theorem.
...
region can therefore exchange Brown--York throat energy by changing boundary
geometry even when no ordinary matter crosses the boundary.  The gravitational
counterpart of Maxwell worldtube rigidity is therefore two-part: no
stress-energy flux through $\mathcal W$, and no Brown--York boundary work,
...
%% ============================================================
\section{From Throat Balance to a Mouth \texorpdfstring{$1/r$}{1/r} Field}
...
Brown--York throat energy, but an exterior mouth $1/r$ coefficient.  This
section connects the two only in regimes where that exterior coefficient is a
well-defined conserved or constraint charge.
...
Thus Lemma~\ref{lem:BY-komar} should be read as a sufficient-condition bridge
from throat data to the mouth coefficient, not as a general uniqueness theorem
...
invariant.  We do not state a fully dynamical mouth-rigidity theorem.  In that
regime the invariant statement available here is the Brown--York worldtube
balance law, not a separate theorem for a finite-radius mouth coefficient.
\end{remark}

For the quasistatic regime contemplated by Dai and Stojkovic, such as the S2
orbit around Sgr~A* with $v/c\sim0.02$, the relevant no-induction statement is
Proposition~\ref{prop:linearized}; Lemma~\ref{lem:BY-komar} is the corresponding
adiabatic stationary limit.  Slow source motion on the far side does not by
itself supply the flux or boundary work needed to change the conserved
$\ell=0$ sector.

%% ============================================================
\section{Application: the Dai--Stojkovic Channel}
\label{sec:ds}
%% ============================================================
...
with a fixed conserved flux sector.  In the regimes established above, the
conservation results rule out such a history for the mouth $1/r$ coefficient.
...
\end{equation}
Thus following the Dai--Stojkovic curve as a function of source position
requires the harmonic sector itself to drift.
Corollary~\ref{cor:maxwell-handle} forbids that drift unless charge crosses the
handle.  The static family therefore consists of solutions in different flux
sectors, not a dynamical trajectory of one physical system.  The sector-drift
formula identifies the Dai--Stojkovic inference as an instance of the
fixed-flux issue discussed by Frolov--Novikov and Krasnikov.  The obstruction
remains even in the short-throat limit where attenuation is absent.
...
monopole solution.  In modern language, the boundary-value problem must be
placed in the correct monopole sector.  The Dai--Stojkovic static matching
...
In the two-ended gravitational setup, the corresponding $1/r$ coefficient is
the ADM mass at an asymptotic end.  Theorem~\ref{thm:adm-rigidity} says that
this end charge is separately conserved.  Source motion in the interior
cannot modulate it.
...
Proposition~\ref{prop:linearized}, the relevant mouth $1/r$ coefficient is
also fixed.  A quasistatic perturber on the other side that does not cross the
throat is therefore not a mechanism for the S2-style time-dependent Newtonian $1/r$
coefficient.
...
\cite{Krasnikov2020CommentObserving}.  The conservation argument here is
different: it treats Maxwell and gravity in the same conserved-sector language
and does not require spherical symmetry.  The proposed signal requires a
changing exterior $1/r$ coefficient or conserved flux sector, while the assumed
source motion supplies no corresponding flux or boundary work.
...
\begin{equation}
  \Delta E_{\mathcal W}[\xi]<0.
\end{equation}
If the boundary geometry changes, the work term must also be included.  Thus a
general sign theorem requires either a stationary boundary or a model-dependent
control of the work term.
...
separated from the mouth, the relevant quantity is the settled mouth $1/r$
...
Cross-throat monopole induction is ruled out when the relevant worldtube has
...
short-throat limit, where no evanescent decay is present; the obstruction is
...
The conserved-sector result changes the observational target.  The removed
channel is the unsuppressed $\ell=0$ response; remaining source-motion signals
must come from $\ell\ge1$ multipoles or waves.  Their potential falls as
...
\end{equation}
Relative to $4\times10^6M_\odot$ this is $\sim3\times10^{-35}$.  This estimate
...
Other wormhole searches probe different channels and are not excluded by the
conserved-sector result.  Pre-existing lensing or mass signatures, wave
scattering, echoes, and transit/backreaction involve either fixed
background parameters, propagating waves, or real flux through the throat
\cite{BaoHouZhang2023GWScattering,CramerEtAl1995NaturalWormholes}.  They
require separate assumptions, not cross-throat monopole induction.
...
This is why the Dai--Stojkovic mechanism fails even in the short-throat limit.
In that limit there is no finite-length attenuation to blame; the obstruction
is conservation of the $\ell=0$ sector.  The proposed signal requires that
sector to vary as the source on the other side moves.  In Maxwell theory this
would be a drift of the handle flux.  In a two-ended gravitational spacetime
it would be a drift of an ADM end charge.  In the single-ended gravitational
case the exact nonlinear invariant available at the throat is the Brown--York
throat energy, and its balance law has no source when both stress-energy flux
and Brown--York boundary work vanish.
...
Brown--York throat-energy balance; this is the transit/backreaction class
...
corresponding flux or boundary work.
...
mouth $1/r$ coefficient is not a canonical invariant.  We therefore leave that
case at the level of the Brown--York worldtube balance law.  In the
...
Observational searches should be normalized to the channel they actually probe:
