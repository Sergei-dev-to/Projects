...
the mass perturbation and obeys the same source balance.  It is local to the
measuring surface and needs neither an asymptotic end nor a compact interior.
The mass perturbation therefore cannot track the source's orbital radius unless
first-order energy crosses the measuring surface.  Higher multipoles, waves,
and dynamical throat effects remain possible.
\end{abstract}
...
Fix the surface embeddings and any asymptotic frame, and define
\begin{equation}
...
measuring surface and any asymptotic frame; a covariantly transformed surface
embedding is equivalent.  Large boundary time rescalings are not gauge
redundancies in this comparison.  The proof is local to $\mathcal T$, and holds
for a single-ended handle.
