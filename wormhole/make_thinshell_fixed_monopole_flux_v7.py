#!/usr/bin/env python3
"""Fixed-monopole-flux field lines for a flat spherical thin-shell wormhole.
...
OUT_PNG = Path("fig_thinshell_fixed_monopole_flux_v7.png")
OUT_PDF = Path("fig_thinshell_fixed_monopole_flux_v7.pdf")
...
def main() -> None:
    ...
    fig.suptitle("Flat thin-shell wormhole: fixed monopole-flux field lines", fontsize=13)
