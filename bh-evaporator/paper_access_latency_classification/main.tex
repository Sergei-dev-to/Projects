...
question addressed here is different: when can private quantum
information become recoverable quickly from the allowed records?
...
\begin{remark}
This theorem closes the toy baseline:
\begin{equation}
