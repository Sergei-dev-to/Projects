...
\end{equation}
 In Fig.~\\ref{fig:PofE} we calibrate the device constant $\\beta$ from the bh-evaporator/main.tex(E)$ slope; with that value fixed, Fig.~\\ref{fig:EtTraj} overlays the parameter-free trajectory from Eq.~\\eqref{eq:PofE}. This makes the BH/lab dictionary explicit: $T,\kappa\propto 1/E$ and $P\propto 1/E^2$.
